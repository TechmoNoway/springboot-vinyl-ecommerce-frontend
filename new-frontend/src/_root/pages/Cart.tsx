                        ...
                        <tbody>
                            <tr className="border-b">
                                <td className="p-2 text-center">
                                    <img
                                        src="/images/cigarettes-after.jpg"
                                        alt="Cigarettes After"
                                        className="w-16 h-16 mr-3"
                                    />
                                </td>
                                <td className="p-2 items-center">Cigarettes After S**</td>
                                <td className="p-2 text-center">{price.toLocaleString()} đ</td>
                                ...
                                <td className="p-2 text-center">{(price * quantity).toLocaleString()} đ</td>
                    ...
                    <div className="bg-gray-100 p-4 mt-12">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex space-x-1 mt-2">
                                <input type="text" className="p-2 border h-9 bg-white w-44 text-sm text-gray-500" />
                ...
                <div className="w-4/12">
                    ...
                    <div className="bg-gray-100 p-4">
                        ...
                        <div className="flex flex-col space-y-4 mt-5">
                            ...
                            <label className="flex space-x-2">
                                ...
                                />
                                <p className="text-[14px]">NHẬN TẠI 11/133 THÁI HÀ (Thanh toán trước & đến lấy)</p>
                            </label>
                        </div>
                        <p className="mt-4">
                    ...
                    <div className="bg-gray-100 p-4 mt-4">
                        ...
                        <div className="flex justify-between mt-10">
                            <span>Tạm tính:</span>
                            <span className="font-semibold">{(price * quantity).toLocaleString()} đ</span>
                        </div>
