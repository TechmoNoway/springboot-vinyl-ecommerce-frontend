        ...
        <div className="w-full items-center flex flex-col justify-center space-y-3">
            ...
            <div className="flex items-center space-x-2">
                <div className="flex flex-col space-y-4">
                    <Button onClick={handleCancelPayment} className="text-xl px-11 py-8">
                        Hủy thanh toán
                    </Button>
                    <Button onClick={handleNavigateToCheckout} className="text-xl px-11 py-8">
            ...
            <div className="mt-4 text-xl font-bold text-center">Thời gian còn lại: {formatTime(countdown)}</div>
        </div>
    );
};
