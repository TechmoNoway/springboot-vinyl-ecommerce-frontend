...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      {/* Header Banner */}
      <div className="bg-[#13151A] text-white p-6 sm:p-8 rounded-xl border-2 border-amber-500 shadow-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="bg-zinc-800 hover:bg-zinc-700 text-amber-400 border border-zinc-600 px-4 py-2.5 text-xs font-bold uppercase rounded flex items-center gap-1.5"
          >
          ...
          <div className="bg-white border-2 border-zinc-900 rounded-lg p-6 shadow-retro space-y-4">
            ...
            <form onSubmit={handleBulkImport} className="space-y-4 pt-2">
              ...
              <button
                ...
                className="w-full bg-[#13151A] hover:bg-black text-amber-300 py-3 px-4 font-extrabold text-xs uppercase tracking-wider flex items-center justify-center gap-2 border border-black shadow-retro-sm"
              >
                {importLoading ? (
          ...
          <div className="bg-white border-2 border-zinc-900 rounded-lg p-6 shadow-retro space-y-4">
            ...
            <form onSubmit={handleSingleImport} className="space-y-4 pt-2">
              ...
              <button
                ...
                className="w-full bg-amber-400 hover:bg-amber-300 text-black py-3 px-4 font-extrabold text-xs uppercase tracking-wider flex items-center justify-center gap-2 border border-black shadow-retro-sm"
              >
                {singleImportLoading ? (
