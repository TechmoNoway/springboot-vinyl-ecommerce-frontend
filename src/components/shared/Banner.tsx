    ...
    <div className="space-y-12">
      ...
      <section className="relative overflow-hidden bg-[#13151A] text-white rounded-2xl mx-4 sm:mx-6 lg:mx-8 mt-6 border-2 border-zinc-800 shadow-2xl">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 py-12 sm:py-16 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          {/* Left Hero Pitch with FadeIn */}
          <FadeIn direction="up" duration={0.5} className="lg:col-span-7 space-y-6 z-10">
          ...
          {/* Right: Spinning Turntable Visualizer with FadeIn */}
          <FadeIn direction="left" delay={0.2} duration={0.6} className="lg:col-span-5 flex justify-center items-center relative">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn direction="up" className="flex items-center justify-between gap-4 mb-4">
            ...
            <StaggerItem key={item.title}>
              <motion.div whileHover={{ y: -3 }} whileTap={{ scale: 0.97 }}>
                <Link
                  ...
                  className="block bg-white border-2 border-zinc-900 rounded-lg p-3 text-center shadow-retro-sm hover:shadow-retro transition-shadow group"
                >
          ...
          <StaggerItem>
            <motion.div whileHover={{ y: -4 }} transition={{ duration: 0.2 }}>
              <Link
                ...
                className="relative h-64 rounded-xl overflow-hidden border-2 border-zinc-900 shadow-retro group block"
              >
                <img
