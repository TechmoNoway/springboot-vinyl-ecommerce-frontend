    ...
    <AnimatePresence>
      {isDrawerOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          {/* Drawer Panel with Swipe In / Out from Right */}
          <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
            <motion.div
              ...
              className="w-screen max-w-md bg-[#FBF9F5] text-[#13151A] shadow-2xl flex flex-col border-l border-zinc-300"
            >
              {/* Header */}
                  ...
                  <AnimatePresence mode="popLayout">
                    {cart.map((item) => (
                      <motion.div
                        ...
                        transition={{ duration: 0.25 }}
                        className="py-4 flex gap-4 items-center overflow-hidden"
                      >
                        <img
                          src={item.posterUrl}
                          alt={item.title}
